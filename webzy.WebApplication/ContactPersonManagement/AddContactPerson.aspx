<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddContactPerson.aspx.cs" Inherits="webzy.WebApplication.ContactPersonManagement.AddContactPerson" %>
...
<body>
	<form id="AddContactPersonForm" class="mainbody" runat="server">
	<div>
	...
	<div id="content" class="row-fluid">
	  ...
	  <div><asp:UpdatePanel ID="UpdatePanelAddContactPerson" runat="server" 
